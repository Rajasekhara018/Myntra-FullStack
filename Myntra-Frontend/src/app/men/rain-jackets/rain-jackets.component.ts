...
@Component({
  selector: 'app-rain-jackets',
  templateUrl: './rain-jackets.component.html',
  styleUrls: ['./rain-jackets.component.scss']
})
export class RainJacketsComponent {
  ...
  getTshirtData() {
    let apiURL = "http://localhost:6062/api/myntra/men/rain-jackets";
