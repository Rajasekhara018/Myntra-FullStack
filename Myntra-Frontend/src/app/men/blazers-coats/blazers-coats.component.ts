...
@Component({
  selector: 'app-blazers-coats',
  templateUrl: './blazers-coats.component.html',
  styleUrls: ['./blazers-coats.component.scss']
})
export class BlazersCoatsComponent {
  ...
  getTshirtData() {
    let apiURL = "http://localhost:6062/api/myntra/men/blazers-coats-shirts";
