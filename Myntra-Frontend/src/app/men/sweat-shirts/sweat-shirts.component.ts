...
@Component({
  selector: 'app-sweat-shirts',
  templateUrl: './sweat-shirts.component.html',
  styleUrls: ['./sweat-shirts.component.scss']
})
export class SweatShirtsComponent {
  ...
  getTshirtData() {
    let apiURL = "http://localhost:6062/api/myntra/men/sweat-shirt";
